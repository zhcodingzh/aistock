...
export const metadata = {
    title: 'About Us | AIStock',
    description: 'The story behind AIStock and the zhcodingzh.',
};
        ...
        <div className="max-w-5xl mx-auto pb-20 px-4">
            ...
            <section className="text-center space-y-8 pt-16 mb-20">
                <div className="flex justify-center mb-6">
                    <div className="p-4 rounded-2xl border border-teal-500/20 backdrop-blur-sm">
                        <img src="/assets/images/logo.png" alt="zhcodingzh" className="h-10 w-auto" />
                    </div>
                </div>
                ...
                <p className="text-xl md:text-2xl text-gray-400 max-w-3xl mx-auto leading-relaxed font-light">
                    ...
                    AIStock is built by the community, for the community.
                </p>
            </section>
            ...
            <section className="grid md:grid-cols-2 gap-12 items-center mb-24 bg-gray-900/30 p-8 md:p-12 rounded-3xl border border-gray-800">
                <div className="space-y-6">
                    <h2 className="text-3xl font-bold text-white">About AIStock</h2>
                    <p className="text-gray-400 leading-relaxed text-lg">
                        AIStock was born from a simple frustration: why are powerful financial tools so expensive?
                    </p>
                    <p className="text-gray-400 leading-relaxed text-lg">
                        We are a collective of developers, designers, and financial enthusiasts working under the <span className="text-teal-400 font-semibold">zhcodingzh</span> banner. Our mission is to democratize software by building high-quality, open-source alternatives to proprietary platforms.
                    </p>
                    <div className="pt-4">
                        <Link href="https://github.com/zhcodingzh" target="_blank" className="inline-flex items-center gap-2 text-teal-400 hover:text-teal-300 font-medium transition-colors group">
